...
Algorithm:
     - initialize new result variable and assign an empty array to it
     - create an array of all the substrings, at least 2 characters long, for a given string and assign it to the substring_arr variable (for that we would need another method, called substrings which would return all the substrings from a given array)
